...
# En desarrollo {data-icon="fa-chart-bar"}

row {data-width=300}
-----------------------------------------------------------------------
### Presentación MRSE
```{r}
embed_xaringan(url = "https://rstudio-pubs-static.s3.amazonaws.com/1038198_cc1b96ffb74446c5a9171b32fa92d943.html#/title-slide",ratio="2:4")
```
